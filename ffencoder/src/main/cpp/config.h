...
#define FFMPEG_CONFIGURATION "--prefix=/home/liangcr/Desktop/ffmpeg-3.3.9/android/armeabi-v7a --arch=arm --cross-prefix=/home/liangcr/Desktop/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi- --extra-ldflags='-L./libx264/lib -L./libfdkacc/lib' --sysroot=/home/liangcr/Desktop/android-ndk-r14b/platforms/android-14/arch-arm --extra-cflags='-Os -fpic -I./libx264/include -I./libfdkacc/include' --target-os=linux --enable-cross-compile --enable-gpl --disable-shared --enable-static --enable-libx264 --enable-encoder=libx264 --enable-nonfree --enable-libfdk-aac --disable-decoders --enable-decoder=h264 --enable-decoder=ac3 --enable-decoder=aac --enable-decoder=mp2 --disable-doc --disable-debug --enable-small --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver"
